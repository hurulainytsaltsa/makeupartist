...
class PackageMakeUpController extends Controller
{
    ...
    {
        $paketMakeup = PackageMakeUp::all();
        return view('layouts.package.create_package', compact('paketMakeup'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/package')->with('success', 'Package MakeUp added successfully.');
    }
    ...
    public function edit(string $id)
    {
         ...
         return view('layouts.package.edit', compact('paketMakeup'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect('/package')->with('success', 'Package MakeUp updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        // Redirect kembali ke halaman profil dengan pesan sukses
        return redirect('/package')->with('pesan', 'Data sudah berhasil dihapus');
    }
}
