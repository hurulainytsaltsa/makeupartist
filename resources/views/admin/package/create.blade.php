...
<div class="container">
    <div class="row g-4">
        ...
        <form action="/dashboard-package" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('harga') is-invalid @enderror" id="harga" name="harga" rows="3" required>{{ old('harga') }}</textarea>
                @error('harga')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
